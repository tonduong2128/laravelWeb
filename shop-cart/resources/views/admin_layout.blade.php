            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{asset('/all-category')}}">Liệt kê danh mục sản phẩm</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{asset('/all-brand')}}">Liệt kê thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
...
<!-- calendar -->
	...
	<!-- //calendar -->
	<script src="{{ asset('public/backend/js/customer.js') }}"></script>
</body>
</html>
