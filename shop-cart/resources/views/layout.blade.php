						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							@forelse ($category as $cat)
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a href="{{URL::to('danh-muc-san-pham/'.$cat->id)}}">{{ $cat->name }}</a>
										</h4>
									</div>
								</div>
							@empty
								<div class="panel panel-default">
									<div class="panel-heading">
										<h4 class="panel-title"><a href="#">Không có danh mục sản phẩm nào</a></h4>
									</div>
								</div>
							@endforelse
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									@forelse ($brand as $bra)
										<li><a href="{{URL::to('thuong-hieu-san-pham/'.$bra->id)}}"> 
											<span class="pull-right">(50)</span>{{$bra->name}}</a>
										</li>
									@empty
										<li>
											<a href="#"> <span class="pull-right"></span>Không có thương hiệu sản phẩm nào</a>
										</li>
									@endforelse
								</ul>
							</div>
